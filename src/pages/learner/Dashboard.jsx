...
export default function Dashboard() {
  ...
  useEffect(() => {
    ...
    try {
      (function() {
          // Quick active state switcher for navigation awareness
...
<span className="material-symbols-outlined text-[15px]" style={{ fontVariationSettings: "'FILL' 1" }}>flag</span>{"Kỳ thi JLPT N3\n            "}</span>
...
<span className="material-symbols-outlined text-[15px]">timer</span>{"Còn 84 ngày\n            "}</span>
...
<span className="material-symbols-outlined text-[14px]">trending_up</span>{"+14% tuần này\n            "}</span>
</div>
<div className="flex flex-col gap-space-xxs">
<h1 className="font-headline-lg text-headline-lg text-on-surface tracking-tight">{"Chào buổi sáng, Lan-san! 🌸\n            "}</h1>
<p className="font-body-md text-body-md text-on-surface-variant leading-relaxed">{"Hôm nay là ngày thuận lợi để củng cố ngữ pháp liệt kê hành động. Bạn đã duy trì nhịp độ liên tục 14 ngày — hãy giữ tinh thần "}<span className="text-primary font-semibold">"Chiritsumo"</span>{" (từng chút một tạo nên điều kỳ diệu).\n            "}</p>
</div>
...
<span className="font-headline-sm text-headline-sm text-on-surface font-bold leading-tight">18/25</span>
<span className="font-label-sm text-label-sm text-outline">Bài học N3</span>
</div>
</div>
...
<div className="flex flex-col">
<span className="font-headline-sm text-headline-sm text-on-surface font-bold leading-tight">720</span>
<span className="font-label-sm text-label-sm text-outline">Từ đã ghi nhớ</span>
</div>
</div>
<div className="w-px h-8 bg-outline-variant/40"></div>
<div className="flex items-center gap-space-xs">
...
<div className="flex flex-col">
<span className="font-headline-sm text-headline-sm text-on-surface font-bold leading-tight">Cấp 8</span>
<span className="font-label-sm text-label-sm text-outline">Võ sĩ Tự học</span>
</div>
</div>
</div>
</div>
...
<span className="font-label-md text-label-md text-primary font-bold uppercase tracking-wider">Đang học dở dang</span>
</div>
<div className="flex items-center gap-1 text-outline font-label-sm text-label-sm">
<span className="material-symbols-outlined text-[16px]">schedule</span>
<span className="">Ước tính: 18 phút còn lại</span>
</div>
</div>
<div className="flex flex-col md:flex-row md:items-center justify-between gap-space-md">
<div className="flex flex-col gap-space-xxs max-w-xl">
<span className="font-label-sm text-label-sm text-on-surface-variant font-medium">Chương 4 • Ngữ pháp cốt lõi N3</span>
<h2 className="font-headline-md text-headline-md text-on-surface font-bold leading-snug">{"Bài 19: Thể quá khứ & Liệt kê hành động (～たり～たりする)\n            "}</h2>
...
<span className="text-on-surface-variant font-semibold">Tiến độ bài học: 40%</span>
<span className="text-primary font-bold">2/5 Phần đã hoàn thành</span>
</div>
<div className="w-full h-2.5 bg-surface-container-high rounded-full overflow-hidden flex">
<div className="h-full bg-gradient-to-r from-secondary-container to-primary rounded-full transition-all duration-500" style={{ width: "40%" }}></div>
</div>
<div className="grid grid-cols-5 gap-1 pt-1 text-center font-label-sm text-[11px] text-outline">
<span className="text-primary font-bold flex items-center justify-center gap-0.5"><span className="material-symbols-outlined text-[13px]">check_circle</span>{" 1. Khởi động"}</span>
<span className="text-primary font-bold flex items-center justify-center gap-0.5"><span className="material-symbols-outlined text-[13px]">check_circle</span>{" 2. Lý thuyết"}</span>
<span className="text-on-surface font-bold flex items-center justify-center gap-0.5"><span className="material-symbols-outlined text-[13px] text-primary">radio_button_checked</span>{" 3. Ví dụ"}</span>
<span className="">4. Luyện tập</span>
<span className="">5. Mini-Test</span>
</div>
</div>
</div>
...
<span className="px-2 py-0.5 rounded-full bg-error-container text-on-error-container font-label-sm text-label-sm font-bold">{"28 từ cần ôn\n                "}</span>
</div>
<div className="flex flex-col">
...
<span className="font-headline-sm text-headline-sm text-primary font-bold">28 thẻ</span>
</div>
...
<span className="font-label-md text-label-md font-bold text-error">12</span>
</div>
<div className="flex items-center justify-between p-2.5 rounded-xl bg-surface-container-low hover:bg-surface-container transition-colors">
<div className="flex items-center gap-2">
...
<span className="font-label-md text-label-md font-bold text-primary">10</span>
</div>
<div className="flex items-center justify-between p-2.5 rounded-xl bg-surface-container-low hover:bg-surface-container transition-colors">
<div className="flex items-center gap-2">
...
<span className="font-label-md text-label-md font-bold text-tertiary">6</span>
</div>
</div>
</div>
...
<span className="font-label-sm text-label-sm text-tertiary font-bold">Mục tiêu 76%</span>
</div>
...
<circle className="text-primary transition-all duration-1000" cx="50" cy="50" fill="transparent" r="40" stroke="currentColor" strokeDasharray="251.2" strokeDashoffset="60" strokeLinecap="round" strokeWidth="8"></circle>
</svg>
<div className="absolute inset-0 flex flex-col items-center justify-center text-center">
<span className="font-headline-sm text-headline-sm text-on-surface font-bold leading-none">14</span>
<span className="font-label-sm text-[10px] text-outline uppercase font-semibold">Ngày streak</span>
</div>
</div>
<div className="flex flex-col gap-1 min-w-0">
<span className="font-title-sm text-title-sm text-on-surface font-bold leading-tight">Vườn hoa Sakura nở rộ</span>
<p className="font-body-sm text-body-sm text-on-surface-variant">{"Hoàn thành 5/7 ngày học mục tiêu trong tuần này để hoa nở toàn phần.\n            "}</p>
</div>
</div>
{/*  Weekly Flower Bloom Days (7 Days)  */}
...
{/*  Day 1: Bloomed  */}
<div className="w-9 h-9 rounded-xl bg-primary text-on-primary flex items-center justify-center shadow-xs" title="Thứ 2: Hoàn thành">
<span className="material-symbols-outlined text-[18px]">local_florist</span>
</div>
{/*  Day 2: Bloomed  */}
<div className="w-9 h-9 rounded-xl bg-primary text-on-primary flex items-center justify-center shadow-xs" title="Thứ 3: Hoàn thành">
<span className="material-symbols-outlined text-[18px]">local_florist</span>
</div>
{/*  Day 3: Bloomed  */}
<div className="w-9 h-9 rounded-xl bg-primary text-on-primary flex items-center justify-center shadow-xs" title="Thứ 4: Hoàn thành">
<span className="material-symbols-outlined text-[18px]">local_florist</span>
</div>
{/*  Day 4: Bloomed  */}
<div className="w-9 h-9 rounded-xl bg-primary text-on-primary flex items-center justify-center shadow-xs" title="Thứ 5: Hoàn thành">
<span className="material-symbols-outlined text-[18px]">local_florist</span>
</div>
{/*  Day 5: Today Active Bloom  */}
<div className="w-9 h-9 rounded-xl bg-secondary-container text-primary flex items-center justify-center animate-pulse" title="Hôm nay: Đang nở">
<span className="material-symbols-outlined text-[18px]" style={{ fontVariationSettings: "'FILL' 1" }}>eco</span>
</div>
{/*  Day 6: Pending  */}
<div className="w-9 h-9 rounded-xl bg-surface-container text-outline flex items-center justify-center" title="Thứ 7: Chưa đến">
<span className="w-2 h-2 rounded-full bg-outline-variant"></span>
</div>
{/*  Day 7: Pending  */}
<div className="w-9 h-9 rounded-xl bg-surface-container text-outline flex items-center justify-center" title="Chủ Nhật: Chưa đến">
<span className="w-2 h-2 rounded-full bg-outline-variant"></span>
</div>
</div>
</div>
</div>
{/*  Upcoming Consultation 1-on-1 Card  */}
<div className="rounded-2xl bg-surface-container-lowest p-space-lg shadow-sm flex flex-col gap-space-md border border-outline-variant/40">
<div className="flex items-center justify-between">
<div className="flex items-center gap-space-xs">
...
<span className="px-2.5 py-0.5 rounded-full bg-tertiary/10 text-tertiary font-label-sm text-label-sm font-bold">Ngày mai</span>
</div>
<div className="flex items-center gap-space-md p-space-sm rounded-xl bg-surface-container-low">
<div className="relative flex-shrink-0">
<img className="w-12 h-12 rounded-xl object-cover" data-alt="Portrait photo of Sensei Tanaka, a friendly Japanese language tutor with warm lighting, wearing casual professional attire in a modern Tokyo office classroom with gentle cherry blossom accents." src="https://lh3.googleusercontent.com/aida-public/AB6AXuAoHjimtK2wVmDLotY-vxCH6suyQ0PNGBkNV7TDvlmRY1Am40uwv3awKwH_Up0DwC0J26jtf778V0UqI8svQ5223QFztq2Wd-sYFKTQRzA7DglBsgs6p2eLnMshM7HidlizqDxjUIyMfB7xpRHTbxDin3tFF7An56I6TrTS9NDa-slqzUsJEew2u6ij5EDEs1j-Hgfiv-tl4KeJjQFRyDu930f6aYudDD8-Z6afs03m-9IVMkdL7POI" />
<span className="absolute -bottom-1 -right-1 w-3.5 h-3.5 rounded-full bg-tertiary ring-2 ring-surface-container-low"></span>
</div>
<div className="flex flex-col min-w-0 flex-1">
<span className="font-title-sm text-title-sm text-on-surface font-bold truncate">Sensei Tanaka Kenji</span>
<span className="font-body-sm text-body-sm text-outline truncate">Giảng viên Chuyên môn JLPT N3/N2</span>
</div>
</div>
...
<span className="">Ngày mai • 19:30 - 20:15 (45 phút)</span>
</div>
<div className="flex items-center gap-2">
<span className="material-symbols-outlined text-outline text-[18px]">record_voice_over</span>
<span className="">{"Nội dung: Sửa phát âm & Hội thoại xử lý tình huống"}</span>
</div>
</div>
