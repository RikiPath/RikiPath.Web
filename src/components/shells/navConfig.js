  ...
  groups: [
    {
      ...
      items: [
        ...
        { to: '/lesson-cms', label: 'Quản lý Bài học', icon: 'menu_book' },
...
export const ADMIN_NAV = {
  ...
  items: [
    ...
    { to: '/consultation', label: 'Gói tư vấn', icon: 'psychology' },
    { to: '/consultation-payment', label: 'Thanh toán', icon: 'payments' },
...
export const LEARNER_NAV = {
  ...
  items: [
    ...
    { to: '/vocabulary', label: 'Sổ từ & Kanji', icon: 'edit_note', alsoActive: ['/kanji-studio', '/kanji-notebook'] },
    { to: '/daily-srs', label: 'Ôn SRS', icon: 'style' },
    { to: '/ai-counselor', label: 'Cố vấn AI', icon: 'psychology' },
    { to: '/consultation', label: 'Tư vấn 1-1', icon: 'support_agent' },
    { to: '/app', label: 'Cài đặt', icon: 'settings', neverActive: true },
  ],
...
export const CONSULT_NAV = {
  ...
  items: [
    ...
    { to: '/booking-schedule', label: 'Đặt lịch HV', icon: 'event_available' },
    { to: '/consultation-hub', label: 'Hub tư vấn', icon: 'hub' },
    { to: '/consultation-center', label: 'Trung tâm', icon: 'apartment' },
    { to: '/consultation-request', label: 'Chi tiết yêu cầu', icon: 'description' },
    { to: '/consultation', label: 'Cổng học viên', icon: 'school' },
  ],
