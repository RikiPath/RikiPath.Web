...
export const ALL_PAGES = [
  ...
  { to: '/feature/shadowing', label: 'Shadowing', page: 'FeatureDetail', group: 'marketing' },
  { to: '/feature/ai-scoring', label: 'AI Chấm thi', page: 'FeatureDetail', group: 'marketing' },
  { to: '/feature/srs', label: 'Kanji SRS', page: 'FeatureDetail', group: 'marketing' },
  { to: '/feature/sensei', label: 'Sensei 1-1', page: 'FeatureDetail', group: 'marketing' },
  // Auth
  ...
  { to: '/verify-email', label: 'Verify Email', page: 'VerifyEmail', group: 'auth' },
  { to: '/update-email', label: 'Update Email', page: 'UpdateEmail', group: 'auth' },
  { to: '/change-password', label: 'Change PW', page: 'ChangePassword', group: 'auth' },
...
export const FLOWS = [
  ...
  },
  {
    ...
    steps: [
      ...
      { n: 2, to: '/feature/shadowing', label: 'Shadowing', page: 'FeatureDetail', hint: 'Shadowing' },
      { n: 3, to: '/feature/ai-scoring', label: 'AI Chấm thi', page: 'FeatureDetail', hint: 'AI' },
      { n: 4, to: '/feature/srs', label: 'Kanji SRS', page: 'FeatureDetail', hint: 'SRS' },
      { n: 5, to: '/feature/sensei', label: 'Sensei 1-1', page: 'FeatureDetail', hint: 'Sensei' },
      { n: 6, to: '/courses', label: 'Danh mục', page: 'CourseCatalog', hint: 'Catalog' },
      { n: 7, to: '/course-detail', label: 'Chi tiết khóa', page: 'CourseDetail', hint: 'Detail' },
      { n: 8, to: '/auth', label: 'Đăng nhập', page: 'Auth', hint: 'Auth' },
      { n: 9, to: '/register', label: 'Đăng ký', page: 'Register', hint: 'Register' },
    ],
  },
  {
    id: 'auth',
    ...
    steps: [
      ...
      { n: 4, to: '/verify-email', label: 'Xác thực email', page: 'VerifyEmail', hint: 'Verify' },
      { n: 5, to: '/update-email', label: 'Đổi email', page: 'UpdateEmail', hint: 'Email' },
      { n: 6, to: '/change-password', label: 'Đổi MK', page: 'ChangePassword', hint: 'Password' },
      { n: 7, to: '/onboarding', label: 'Onboarding', page: 'OnboardingSurvey', hint: 'Survey' },
    ],
  },
  {
    id: 'learner',
